...
plt.plot(inliers_x, model.predict(inliers_x), color='red')
plt.scatter(inliers_final[0], inliers_final[1], color = 'r')
plt.scatter(outliers_final[0], outliers_final[1], color = 'b')
